...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileUploadReference.order'
        db.add_column('adminfiles_fileuploadreference', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileUploadReference.order'
        db.delete_column('adminfiles_fileuploadreference', 'order')


    models = {
        'adminfiles.filegallery': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'FileGallery'},
        ...
        'adminfiles.fileupload': {
            'Meta': {'ordering': "['title', '-upload_date']", 'object_name': 'FileUpload'},
            ...
            'uploaded_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'uploaded_files'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'adminfiles.fileuploadreference': {
            'Meta': {'ordering': "('order', '-id')", 'unique_together': "(('upload', 'content_type', 'object_id'),)", 'object_name': 'FileUploadReference'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '10', 'null': 'True'}),
