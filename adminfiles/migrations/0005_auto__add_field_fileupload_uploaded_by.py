...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileUpload.uploaded_by'
        db.add_column('adminfiles_fileupload', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='uploaded_files', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileUpload.uploaded_by'
        db.delete_column('adminfiles_fileupload', 'uploaded_by_id')
